...
function InputBox() {
    const { messages, setMessages, inputValue, setInputValue, setMetadata,socketRef,logsContainerRef,isConnected, setIsConnected,Research, setResearch,ShowLogs, setShowLogs,showPanel,
      setShowPanel } = useContext(AppContext);
  ...
  useEffect(() => {
    ...
    socketRef.current = new WebSocket("ws://" + window.location.host + "/ws/research");  // for cloud deployment 
